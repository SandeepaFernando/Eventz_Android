...
public class AddEventsActivity extends AppCompatActivity implements SkillAdapterAddEvent.onItemClickListener {
    ...
    private RequestQueue mRequestQueueDate;
    ...
    LinearLayout checkDateAvailability;
    ...
    TextView numGold;
    TextView numSilver;
    TextView txt_check_date_availability;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        checkDateAvailability = findViewById(R.id.get_available_date_layout);
        ...
        txt_check_date_availability = findViewById(R.id.txt_check_date_availability);
        ...
        btn_getbtnAvailable = findViewById(R.id.btn_get_available_date);
        ...
        btn_getbtnAvailable.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                getAvailableDate();
            }
    ...
    private void getAvailableDate() {
        mRequestQueueDate = Volley.newRequestQueue(this);
        String dateTime = textInputDate.getText().toString() + " " + textInputTime.getText().toString();
        String tagString = skillIdArr.toString();
        String tags = tagString.replaceAll("[\\[\\]() ]", "");
        String url = getString(R.string.ip);
        String URL = url + "checkDateAvailability?date=" + dateTime +":00"+ "&tags=" + tags.trim();
        Log.i("getAvailableDate", URL);
                ...
                new Response.Listener<JSONObject>() {
                    ...
                    public void onResponse(JSONObject response) {
                        try {
                            ...
                            // set visible
                            checkDateAvailability.setVisibility(View.VISIBLE);
                            txt_check_date_availability.setText(result);
